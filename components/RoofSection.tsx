      ...
      >
        <defs>
          <pattern id="hatch" width="7" height="7" patternTransform="rotate(45)" patternUnits="userSpaceOnUse">
            <line x1="0" y1="0" x2="0" y2="7" stroke="#6BA6FF" strokeOpacity="0.35" strokeWidth="1" />
          </pattern>
        </defs>

        {/* Contour principal — s'anime au chargement */}
        <g className="draw" fill="none" stroke="#6BA6FF" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round">
        ...
        <g stroke="#6BA6FF" strokeWidth="1" strokeOpacity="0.75" fill="none">
        ...
        <g fill="none" stroke="#6BA6FF" strokeWidth="1" strokeOpacity="0.85">
        ...
        <g stroke="#6BA6FF" strokeWidth="1" strokeOpacity="0.55">
        ...
        <g fill="none" stroke="#6BA6FF" strokeWidth="1.4">
        ...
        <g fill="none" stroke="#6BA6FF" strokeWidth="1.3">
        ...
        {/* Annotation de pente */}
        <g fill="none" stroke="#6BA6FF" strokeWidth="1" strokeOpacity="0.8">
        ...
        >
          {/* leaders */}
          <g stroke="#6BA6FF" strokeWidth="0.75" strokeOpacity="0.5">
        ...
        <g>
          <rect x="596" y="452" width="256" height="56" fill="none" stroke="#6BA6FF" strokeOpacity="0.6" strokeWidth="1" />
          <line x1="596" y1="474" x2="852" y2="474" stroke="#6BA6FF" strokeOpacity="0.6" strokeWidth="1" />
          <text x="606" y="467" fontFamily="ui-monospace, Menlo, monospace" fontSize="10" letterSpacing="0.12em" fill="#6BA6FF">
            COUPE — TOITURE ARDOISE
          </text>
          <text x="606" y="490" fontFamily="ui-monospace, Menlo, monospace" fontSize="10" letterSpacing="0.12em" fill="#6BA6FF" fillOpacity="0.75">
