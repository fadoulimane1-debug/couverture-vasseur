  ...
  return (
    <section className="blueprint-grid">
      <div className="mx-auto max-w-3xl px-5 py-24 text-center md:px-8 md:py-32">
        ...
        <h1 className="mt-4 font-display text-4xl text-papier md:text-5xl">
          Cette page n’est pas au plan
        </h1>
        <p className="mx-auto mt-4 max-w-prose2 text-papier/75">
        ...
        <div className="mt-8 flex flex-wrap justify-center gap-3">
          <Link
            href="/"
            className="rounded-[2px] bg-encre px-5 py-3 font-mono text-[0.78rem] uppercase tracking-label text-white hover:bg-ciel hover:text-nuit"
          >
            Retour à l’accueil
          </Link>
          <PhoneLink variant="ghost" />
        </div>
        <nav className="mt-10 font-mono text-[0.75rem] uppercase tracking-label text-papier/55">
          <Link href={`/${primaryPrestationSlug}`} className="hover:text-ciel">
            Réfection ardoise
          </Link>
          <span className="mx-3 text-papier/25">·</span>
